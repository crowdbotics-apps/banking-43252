"""
Django settings for banking_43252 project.
...
ROOT_URLCONF = 'banking_43252.urls'
...
WSGI_APPLICATION = 'banking_43252.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "banking_43252 API",
    "DESCRIPTION": "API documentation for banking_43252 App",
    "VERSION": "v1",
}
